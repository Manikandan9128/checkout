                      ...
                      <div style={{position:"relative"}} onMouseEnter={() => setLearnHover(true)} onMouseLeave={() => setLearnHover(false)}>
                        ...
                        {learnHover && (
                          <div style={{position:"absolute", top:"100%", left:0, zIndex:9999, minWidth:"260px", borderRadius:"12px", overflow:"hidden", boxShadow:"0 8px 32px rgba(0,0,0,0.15)"}}>
                            <a href="/tutorials" style={{display:"flex", alignItems:"center", gap:"12px", padding:"18px 24px", backgroundColor:"rgb(129,67,152)", color:"#ffffff", textDecoration:"none"}}>
                              <div style={{color:"#ffffff", width:"32px", height:"32px", flexShrink:0}}>
                              ...
                              <span style={{color:"#ffffff", fontWeight:600, fontSize:"16px"}}>Tech Tutorials</span>
                            </a>
                            <a href="/blogs" style={{display:"flex", alignItems:"center", gap:"12px", padding:"18px 24px", backgroundColor:"#ffffff", textDecoration:"none"}}>
                              <div style={{color:"rgb(129,67,152)", width:"32px", height:"32px", flexShrink:0}}>
                              ...
                              <span style={{color:"rgb(58,58,58)", fontWeight:500, fontSize:"16px"}}>Resources</span>
                            </a>
                          </div>
                        )}
                      </div>
