    ...
    <div className="min-h-screen bg-white font-sans" data-comp="home">
      ...
      <header>
        <div data-w-id="5b56ab36-260c-0462-ceea-c6b8266c509e" data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" className="navbar w-nav">
          ...
          <div className="w-nav-overlay" data-wf-ignore="" id="w-nav-overlay-0" style={menuOpen ? {display:"block", height:"auto", position:"fixed", top:0, left:0, right:0, bottom:0, zIndex:9999, background:"#fff", overflowY:"auto"} : {display:"none"}}>
            <nav role="navigation" className="navigation-content-holder w-nav-menu" style={{display:"flex", flexDirection:"column", padding:"0", background:"#fff", minHeight:"100%"}}>
              {/* Mobile menu header */}
              <div style={{display:"flex", alignItems:"center", justifyContent:"space-between", padding:"20px 24px", borderBottom:"1px solid #f0f0f0"}}>
                ...
                <button onClick={() => setMenuOpen(false)} style={{background:"none", border:"none", cursor:"pointer", padding:"4px", display:"flex", alignItems:"center", justifyContent:"center"}}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 6L6 18M6 6l12 12" stroke="#1A1A1A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </button>
              </div>
              {/* Nav links */}
              <div style={{display:"flex", flexDirection:"column", padding:"8px 24px 24px"}}>
                <a href="/" className="nav-links w-inline-block" style={{padding:"18px 0", borderBottom:"1px solid #f0f0f0", textDecoration:"none", color:"#1A1A1A", fontSize:"16px", fontWeight:500}}><div>Home</div></a>
                <a href="/about-us" className="nav-links w-inline-block" style={{padding:"18px 0", borderBottom:"1px solid #f0f0f0", textDecoration:"none", color:"#1A1A1A", fontSize:"16px", fontWeight:500}}><div>About</div></a>
                <a href="/plan" className="nav-links w-inline-block" style={{padding:"18px 0", borderBottom:"1px solid #f0f0f0", textDecoration:"none", color:"#1A1A1A", fontSize:"16px", fontWeight:500}}><div>Plans</div></a>
                <a href="/service" className="nav-links w-inline-block" style={{padding:"18px 0", borderBottom:"1px solid #f0f0f0", textDecoration:"none", color:"#1A1A1A", fontSize:"16px", fontWeight:500}}><div>Services</div></a>
                <div style={{borderBottom:"1px solid #f0f0f0", cursor:"pointer"}} onClick={() => setLearnHover(v => !v)}>
                  <div style={{display:"flex", alignItems:"center", justifyContent:"space-between", padding:"18px 0"}}>
                    <span style={{fontSize:"16px", fontWeight:500, color:"#1A1A1A"}}>Resources</span>
                    <svg width="16" height="16" viewBox="0 0 12 12" fill="none" style={{transition:"transform 0.2s", transform: learnHover ? "rotate(180deg)" : "rotate(0deg)"}}><path d="M2 4L6 8L10 4" stroke="#1A1A1A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                  {learnHover && (
                    <div style={{paddingBottom:"8px", display:"flex", flexDirection:"column", gap:"0"}}>
                      <a href="/tutorials" style={{display:"flex", alignItems:"center", gap:"14px", padding:"14px 16px", textDecoration:"none", color:"rgb(30,30,30)", borderRadius:"8px"}}>
                        <span style={{color:"#814398", width:"24px", height:"24px", flexShrink:0}}>
                        ...
                        <span style={{fontWeight:500, fontSize:"15px"}}>Tech Tutorials</span>
                      </a>
                      <a href="/blogs" style={{display:"flex", alignItems:"center", gap:"14px", padding:"14px 16px", textDecoration:"none", color:"rgb(30,30,30)", borderRadius:"8px"}}>
                        <span style={{color:"#814398", width:"24px", height:"24px", flexShrink:0}}>
                        ...
                        <span style={{fontWeight:500, fontSize:"15px"}}>Blogs</span>
                      </a>
                      <a href="/emergency-contact" style={{display:"flex", alignItems:"center", gap:"14px", padding:"14px 16px", textDecoration:"none", color:"rgb(30,30,30)", borderRadius:"8px"}}>
                        <span style={{color:"#814398", width:"24px", height:"24px", flexShrink:0}}>
                          <svg width="100%" height="100%" viewBox="0 0 21 22" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M12.0564 1.6357e-07C13.8942 -9.83643e-06 15.3498 -2.98917e-05 16.489 0.15314C17.6614 0.31076 18.6104 0.64288 19.3588 1.39124C20.1071 2.13961 20.4392 3.08856 20.5969 4.26098C20.75 5.40018 20.75 6.85581 20.75 8.69354V12.8064C20.75 14.6441 20.75 16.0998 20.5969 17.239C20.4392 18.4114 20.1071 19.3604 19.3588 20.1088C18.6104 20.8571 17.6614 21.1892 16.489 21.3469C15.3498 21.5 13.8942 21.5 12.0565 21.5H10.4436C8.6059 21.5 7.15018 21.5 6.01098 21.3469C4.83856 21.1892 3.88961 20.8571 3.14124 20.1088C2.50477 19.4723 2.16938 18.6907 1.98635 17.75H1C0.44772 17.75 0 17.3023 0 16.75C0 16.1977 0.44772 15.75 1 15.75H1.78442C1.74998 14.9003 1.74999 13.924 1.75 12.8064V11.75H1C0.44772 11.75 0 11.3023 0 10.75C0 10.1977 0.44772 9.75 1 9.75H1.75V8.69358C1.74999 7.57601 1.74998 6.59973 1.78442 5.75H1C0.44772 5.75 0 5.30229 0 4.75C0 4.19772 0.44772 3.75 1 3.75H1.98635C2.16938 2.80927 2.50477 2.02771 3.14124 1.39124C3.88961 0.64288 4.83856 0.31076 6.01098 0.15314C7.15019 -2.98917e-05 8.6058 -9.83643e-06 10.4436 1.6357e-07H12.0564ZM9.0746 5.52512C9.4666 5.60614 9.7617 5.86643 9.9357 6.17865L10.3451 6.91322C10.4866 7.16694 10.6213 7.40852 10.7118 7.62464C10.8132 7.86668 10.8889 8.14247 10.8557 8.46083C10.8225 8.7792 10.6915 9.0334 10.5424 9.2493C10.4092 9.4421 10.2276 9.6507 10.0368 9.8698L9.2261 10.801C9.9253 11.8628 10.885 12.8229 11.9478 13.5227L12.879 12.712C13.098 12.5213 13.3067 12.3396 13.4995 12.2064C13.7154 12.0573 13.9696 11.9263 14.288 11.8931C14.6063 11.8599 14.8821 11.9356 15.1242 12.037C15.3403 12.1275 15.5818 12.2622 15.8356 12.4037L16.5702 12.8131C16.8824 12.9872 17.1427 13.2822 17.2237 13.6742C17.3059 14.0721 17.1796 14.4547 16.9407 14.7478C16.2355 15.613 15.0814 16.1921 13.8432 15.9423C13.1505 15.8026 12.4669 15.5686 11.6514 15.1009C10.0284 14.1701 8.5776 12.7185 7.64791 11.0974C7.1802 10.2819 6.94625 9.5983 6.80651 8.9056C6.55674 7.66735 7.13577 6.5133 8.00097 5.80813C8.29413 5.56918 8.6767 5.44287 9.0746 5.52512Z" fill="currentcolor"/></svg>
                        </span>
                        <span style={{fontWeight:500, fontSize:"15px"}}>Emergency Contact</span>
                      </a>
                      <a href="/customer-support" style={{display:"flex", alignItems:"center", gap:"14px", padding:"14px 16px", textDecoration:"none", color:"rgb(30,30,30)", borderRadius:"8px"}}>
                        <span style={{color:"#814398", width:"24px", height:"24px", flexShrink:0}}>
                          <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M12.0002 4C8.74885 4 6.31489 6.09486 6.02849 8.52063C6.15063 8.57303 6.26834 8.62684 6.37501 8.67566C6.73116 8.83478 7.40272 9.13482 7.6585 9.89191C7.75152 10.1672 7.75079 10.4616 7.75011 10.7355V15.2645C7.75079 15.5384 7.75152 15.8327 7.6585 16.1081C7.40272 16.8652 6.73116 17.1652 6.37501 17.3243C6.0121 17.4904 5.52133 17.7144 5.16362 17.7434C4.76625 17.7755 4.36396 17.6906 4.01491 17.4947C3.69791 17.3168 3.45992 17.0265 3.21887 16.7323C3.13171 16.6265 2.96671 16.4318 2.85082 16.2975C2.63896 16.052 2.39839 15.7733 2.20005 15.5137C1.8724 15.0849 1.54407 14.5711 1.38098 13.9741C1.20634 13.3348 1.20634 12.6652 1.38098 12.0259C1.49932 11.5927 1.71345 11.2104 1.99611 10.8091C2.26984 10.4205 2.73604 9.85098 3.19205 9.29711C3.26557 9.20387 3.36665 9.07569 3.44139 8.99009C3.57673 8.83505 3.76401 8.64608 4.01491 8.50526L4.0196 8.50263C4.31352 4.74952 7.91074 2 12.0002 2C16.0897 2 19.6869 4.74952 19.9809 8.50264L19.9855 8.50526C20.2364 8.64608 20.4237 8.83505 20.5591 8.99009C20.6338 9.07569 20.7349 9.20386 20.8084 9.2971C21.2644 9.85097 21.7306 10.4205 22.0044 10.8091C22.287 11.2104 22.5011 11.5927 22.6195 12.0259C22.7941 12.6652 22.7941 13.3348 22.6195 13.9741C22.4564 14.5711 22.1281 15.0849 21.8004 15.5137C21.6021 15.7733 21.3616 16.052 21.1497 16.2975C21.0339 16.4318 20.8688 16.6265 20.7816 16.7323C20.5443 17.0218 20.3099 17.3078 20.0002 17.4864V17.8C20.0002 20.3163 17.5419 22 15.0002 22H13.0002C12.4479 22 12.0002 21.5523 12.0002 21C12.0002 20.4477 12.4479 20 13.0002 20H15.0002C16.8768 20 18.0002 18.8183 18.0002 17.8V17.4914C17.868 17.4353 17.7403 17.3769 17.6255 17.3243C17.2693 17.1652 16.5977 16.8652 16.342 16.1081C16.2489 15.8327 16.2497 15.5384 16.2503 15.2645V10.7355C16.2497 10.4616 16.2489 10.1672 16.342 9.89191C16.5977 9.13482 17.2693 8.83478 17.6255 8.67566C17.7321 8.62684 17.8498 8.57303 17.972 8.52063C17.6856 6.09486 15.2516 4 12.0002 4Z" fill="currentcolor"/></svg>
                        </span>
                        <span style={{fontWeight:500, fontSize:"15px"}}>Customer Support</span>
                      </a>
                    </div>
                  )}
                </div>
                <a href="/community" className="nav-links w-inline-block" style={{padding:"18px 0", borderBottom:"1px solid #f0f0f0", textDecoration:"none", color:"#1A1A1A", fontSize:"16px", fontWeight:500}}><div>Community</div></a>
                <div style={{paddingTop:"24px"}}>
                  <a href="/contact-us" style={{display:"block", padding:"14px 24px", borderRadius:"999px", border:"2px solid #814398", color:"#814398", textDecoration:"none", fontWeight:600, textAlign:"center", fontSize:"16px"}}>Contact Us</a>
                </div>
              </div>
            </nav>
          </div>
