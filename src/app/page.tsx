                ...
                <div className="navbar-component">
                  ...
                  <nav role="navigation" className="navigation-content-holder w-nav-menu">
                    <div className="navbar-link-holder">
                      ...
                      <div data-delay="0" data-hover="true" className="nav-megamenu-dropdown w-dropdown" style={{position:"relative"}} onMouseEnter={() => setLearnHover(true)} onMouseLeave={() => setLearnHover(false)}>
                        <div className="nav-megamenu-toggle w-dropdown-toggle" id="w-dropdown-toggle-0" aria-controls="w-dropdown-list-0" aria-haspopup="menu" aria-expanded={learnHover ? "true" : "false"} role="button" tabIndex={0}>
                          <div>Learn</div>
                          <div className="megamenu-icon w-icon-dropdown-toggle" aria-hidden="true"></div>
                        </div>
                        <nav className="navbar-dropdown-navigation w-dropdown-list" id="w-dropdown-list-0" aria-labelledby="w-dropdown-toggle-0" style={{display: learnHover ? "block" : "none", position:"absolute", top:"100%", left:0, zIndex:1000, minWidth:"260px", borderRadius:"12px", overflow:"hidden", boxShadow:"0 8px 32px rgba(0,0,0,0.12)"}}>
                          <div className="navbar-dropdown-linkholder" style={{padding:0}}>
                            <a href="/tutorials" className="navbar-linkblock is-radius-none w-inline-block" tabIndex={0} onMouseEnter={() => setTechHover(true)} onMouseLeave={() => setTechHover(false)} style={{display:"flex", alignItems:"center", gap:"12px", padding:"18px 24px", backgroundColor: techHover ? "rgb(129,67,152)" : "rgb(129,67,152)", color:"#ffffff", textDecoration:"none"}}>
                              <div className="navbar-link-icon w-embed" style={{color:"#ffffff", width:"32px", height:"32px", flexShrink:0}}>
                              ...
                              <div className="navbar-link-text" style={{color:"#ffffff", fontWeight:600, fontSize:"16px"}}>Tech Tutorials</div>
                            </a>
                            <a href="/blogs" className="navbar-linkblock w-inline-block" tabIndex={0} style={{display:"flex", alignItems:"center", gap:"12px", padding:"18px 24px", backgroundColor:"#ffffff", color:"rgb(129,67,152)", textDecoration:"none"}}>
                              <div className="navbar-link-icon w-embed" style={{color:"rgb(129,67,152)", width:"32px", height:"32px", flexShrink:0}}>
                              ...
                              <div className="navbar-link-text" style={{color:"rgb(58,58,58)", fontWeight:500, fontSize:"16px"}}>Resources</div>
                            </a>
                          </div>
                        </nav>
                      </div>
                    ...
                    <div className="navbar-rightholder">
                      <div className="navbar-cta-wrap" onMouseEnter={() => setCtaHover(true)} onMouseLeave={() => setCtaHover(false)} style={{cursor:"pointer",position:"relative"}}>
                        ...
                        <a href="/contact-us" className="navbar-cta-text" style={{color: ctaHover ? "#ffffff" : "rgb(129, 67, 152)", transition:"color 0.3s ease", position:"relative", zIndex:1, textDecoration:"none"}}>Contact Us</a>
                      </div>
                    </div>
                  </nav>
