...
export default function CheckoutForm({ genderOptions, relationshipOptions, languages, platforms }: Props) {
  ...
  useEffect(() => {
    ...
    setDeviceModel("");
    fetch(`/api/proxy?path=${encodeURIComponent("/api/administration/device-model-list/")}&query=${encodeURIComponent(`platform=${device}`)}`)
      .then((r) => r.json())
  ...
  const inputClass = "w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200 transition";
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative mb-4" ref={langDropdownRef}>
            ...
            <div className={`${inputClass} flex min-h-[48px] cursor-pointer items-center justify-between`} onClick={() => setShowLangDropdown((v) => !v)}>
            ...
            {showLangDropdown && (
              <div className="absolute z-10 mt-1 flex max-h-56 w-full flex-col gap-1 overflow-y-auto rounded-lg border border-purple-200 bg-white p-1.5 shadow-lg">
                {languages.map((lang) => {
          ...
          {error && (
            <div className="mb-4 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 whitespace-pre-wrap">{error}</div>
          )}
      ...
      <footer className="mt-16 border-t border-gray-100 bg-white">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 px-4 py-10 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600"><li>Home</li><li>About us</li><li>Plan</li><li>Services</li><li>Learn</li><li>Community</li></ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600"><li>Terms &amp; Conditions</li><li>Privacy Policy</li><li>Disclaimer</li></ul>
          </div>
        </div>
